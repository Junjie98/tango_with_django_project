...
def populate():
    ...
    python_pages = [{'title': 'Official Python Tutorial', 'url':'http://docs.python.org/3/tutorial/', 'views':24},
 ...
 {'title':'How to Tango with Django', 'url':'http://www.tangowithdjango.com/', 'views':38}]

    other_pages = [{'title':'Bottle', 'url':'http://bottlepy.org/docs/dev/', 'views':44},
    ...
    for cat, cat_data in cats.items():
        c = add_cat(cat, views=cat_data['views'], likes=cat_data['likes']) #bacause page req category ref.
